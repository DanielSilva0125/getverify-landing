...
export default function HeroSection() {
  return (
    <main className="relative flex flex-col px-6 pt-20 pb-16 sm:pt-28 sm:pb-20 lg:pt-16">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 mb-20 sm:mb-16 lg:px-12">
        ...
        <div className="flex flex-col items-start max-w-[620px]">
          ...
          <motion.h1
            {...fadeUp(0.1)}
            className="text-[36px] leading-[1.15] sm:text-[48px] sm:leading-[1.12] lg:text-[56px] lg:leading-[1.04] font-semibold tracking-[-0.025em] text-dark-teal mb-5"
          >
            Controla el cumplimiento<br />de <ShiningText text="contratistas" className="text-[36px] sm:text-[48px] lg:text-[56px] font-semibold tracking-[-0.025em]" /> desde<br />
